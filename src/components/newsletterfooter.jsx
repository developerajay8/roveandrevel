        ...
        <div className="max-w-[1240px] mx-auto px-4 py-8 md:py-10">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 mb-8">
            ...
            <nav className="flex flex-wrap justify-center items-center font-medium gap-4 md:gap-8 text-sm md:text-base">
              <a href="#about" className="hover:text-[#D19B06] transition-colors">About</a>
              <a href="#tickets" className="hover:text-[#D19B06] transition-colors">Tickets</a>
              <a href="#speakers" className="hover:text-[#D19B06] transition-colors">Speakers</a>
              <a href="#gallery" className="hover:text-[#D19B06] transition-colors">Gallery</a>
              <a href="#pricing" className="hover:text-[#D19B06] transition-colors">Pricing</a>
              <a href="#faq" className="hover:text-[#D19B06] transition-colors">FAQ</a>
              <a href="#contact" className="hover:text-[#D19B06] transition-colors">Contact</a>
            </nav>

            {/* Social Icons */}
            <div className="flex gap-3">
              <a href="#twitter" className="w-10 h-10 md:w-12 md:h-12 rounded-full  hover:bg-gradient-to-b from-[#A27806] to-[#D19B06] border-[1px] border-[#7A38FC] font-bold text-white flex items-center justify-center transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="#facebook" className="w-10 h-10 md:w-12 md:h-12 hover:bg-gradient-to-b from-[#A27806] to-[#D19B06] border-[1px] border-[#7A38FC] rounded-full  flex items-center justify-center transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#linkedin" className="w-10 h-10 md:w-12 md:h-12 hover:bg-gradient-to-b from-[#A27806] to-[#D19B06] border-[1px] border-[#7A38FC] rounded-full  flex items-center justify-center transition-colors">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="#vimeo" className="w-10 h-10 md:w-12 hover:bg-gradient-to-b from-[#A27806] to-[#D19B06] border-[1px] border-[#7A38FC] md:h-12 rounded-full  flex items-center justify-center transition-colors">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-gray-700 text-[16px] ">
            ...
            <div className="flex gap-6">
              ...
              <a href="#privacy" className="text-[#DBDADB] transition-colors">Privacy Policy</a>
            </div>
          </div>
        </div>
      </div>
