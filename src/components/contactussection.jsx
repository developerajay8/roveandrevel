      ...
      <div className="max-w-[1196px] mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-base md:text-lg">
            Discover the magic we've created for our clients across different
            event categories
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 max-w-[1220px] mx-auto shadow-2xl rounded-3xl overflow-hidden">
          ...
          <div className="bg-[#2D3A67] rounded-2xl m-2.5 p-8 sm:p-10 lg:p-12 text-white relative overflow-hidden col-span-2">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end pt-4">
                <button
                  ...
                  className={`px-[38.5px] py-[11px] rounded-full font-medium text-[16px] transition cursor-pointer ${
                    isSubmitting
                      ? "opacity-50 cursor-not-allowed bg-gray-300 text-gray-600"
                      : "bg-gradient-to-b from-[#A27806] to-[#D19B06] hover:bg-[#a07700] text-[#FFFFFF]"
                  }`}
                >
