...
export default function Hero() {
  return (
    <section aria-label="Hero" className="">
      <div
        className="w-full relative bg-cover bg-center h-[500px] md:h-[600px] "
        ...
        <div className="max-w-[1240px]  mx-auto h-full px-4 md:px-6 pt-[128px]">
          <div className="max-w-2xl absolute text-white">
            ...
            <p className="mt-8 max-w-xl leading-relaxed text-[#FFF5D9]">
              Where wanderlust meets celebration. Premium event planning and
              hospitality services that transform moments into memories.
            </p>
            <div className="mt-8">
              <a
                href="/contact"
