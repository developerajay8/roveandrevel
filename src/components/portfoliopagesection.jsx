                ...
                <div className="md:block hidden">
                    <div className="max-w-[1240px]  mx-auto grid grid-cols-7 gap-5">
                        ...
                        <div className="col-span-2 h-full">
                            <div className="pb-5"><img className='' src="/image 1 (12).png" alt="" /></div>
                            <div className=""><img className=' ' src="/image 2 (9).png" alt="" /></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="md:hidden block">
                    <div className="max-w-[1240px]  mx-auto  gap-5">
                        <div className="space-y-5 w-fit">
                            <div className=""><img className='mx-auto' src="/Elegant Wedding Decorations.svg" alt="" /></div>
                            <div className=""><img className='mx-auto' src="/Manavarai Decoration - Wedding Planners in Coimbatore Tamilnadu India.svg" alt="" /></div>

                            <div className=""><img className='mx-auto' src="/latest wedding ceremony stage decoration ideas.svg" alt="" /></div>
                            <div className=""><img className='mx-auto' src="/Low Budget Wedding Stage Decoration Ideas - For Indian Weddings.svg" alt="" /></div>
                            <div>
                                <img className='mx-auto' src="/Anil Caterers - Wedding Caterers In Bangalore.svg" alt="" />
                            </div>

                            <div className=""><img className='mx-auto'  src="/Home Decor Hacks For Your Wedding (1).svg" alt="" /></div>
                            <div className=""><img className='mx-auto'  src="/Chicken Milega Kya_ (1).svg" alt="" /></div>
                        </div>
                    </div>
                </div>
