...
const Contactnow = () => {
    return (
      ...
      style={{
        backgroundImage: `url('/Mandala art_Blue mandala art (1).svg')`, // replace or remove (you said you'll add inline)
      }}
    >
      ...
      <div className="relative z-10 px-4 md:px-8">
        ...
        <p className='text-[#D1D1D1] text-[15px] mb-10 text-center'>We 've got it covered!</p>
